...
const double C_LONG_LAUNCH_VEL_CEN		= 0.75 * C_LAUNCH_MAX_WHEEL_VEL; //0.9
const double C_LONG_LAUNCH_VEL_OUT		= 0.70 * C_LAUNCH_MAX_WHEEL_VEL; //0.85
...
#define C_LAUNCH_CEN_READY_BAND		5.0 // % Output
#define C_LAUNCH_OUT_READY_BAND		5.0 //% Output; probably have a larger tolernce to the outer wheel speed comepared to the inner
